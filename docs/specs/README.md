...
| [05-character-lifecycle.md](05-character-lifecycle.md) | Create, name/server-cap edit, race switch (wipe), hard delete, user ownership, auth-required, opt-in public share link (read-only, private by default) | draft |
