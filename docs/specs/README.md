...
| [05-character-lifecycle.md](05-character-lifecycle.md) | Create, name/server-cap edit, race switch (wipe), hard delete, user ownership, auth-required, public share link (read-only) | draft |
